...
@Category(BatchedTaskExecutorServiceMutithreadedTest.class)
public class BatchedTaskExecutorServiceMutithreadedTest {
	...
	public void testMultithreaded() throws InterruptedException {
		List<Callable<Object>> workers = new ArrayList<Callable<Object>>(NUM_THREADS);
