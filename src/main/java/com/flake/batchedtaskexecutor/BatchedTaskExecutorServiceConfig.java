...
public class BatchedTaskExecutorServiceConfig {
	...
	/**
	 * @param maxBufferedTasks
	 *            The maximum number of Tasks that may be stored in a buffer.
	 *            When the limit is reached, the tasks will be executed
	 * @param maxPendingTaskTimeSeconds
	 *            The maximum time, in seconds, that Tasks may be stored in a
